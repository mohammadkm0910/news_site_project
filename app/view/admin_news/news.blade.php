                ...
                <div class="table-responsive resizable">
                    <table class="table-page">
                        ...
                        <tr>
                            ...
                            <td><img class="img-outline" src="<?php $this->asset($n['image']); ?>"
                                     alt="<?php echo $n['title'][0]; ?>"></td>
                            ...
                            <td class="single-line">
                                <a href="<?php $this->url('admin/news/edit/'.$n['id'][0]); ?>"
                                   class="btn btn-icon btn-warning"><i class="fas fa-edit"></i></a>
                                <a href="<?php $this->url('admin/news/show/'.$n['id'][0]); ?>"
                                   class="btn btn-icon btn-info"><i class="fas fa-info"></i></a>
                                <a class="btn btn-icon btn-danger"
                                   onclick="deleteNews('<?php $this->url('admin/news/destroy/'.$n['id'][0]); ?>')"><i
