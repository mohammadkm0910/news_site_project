                ...
                <table class="table-group">
                    ...
                    <tr>
                        ...
                        <td class="single-line">
                            <a onclick="editGroup('<?php $this->url('admin/groups/edit/'.$id); ?>')"
                               class="btn btn-icon btn-warning"><i class="fas fa-edit"></i></a>
                            <a href="<?php $this->url('admin/groups/show/'.$id); ?>" class="btn btn-icon btn-info"><i
                                        class="fas fa-info"></i></a>
                            <a onclick="deleteGroup('<?php $this->url('admin/groups/destroy/'.$id); ?>')"
